...
def login_screen():
    # Počni s login containerom
    st.markdown("""
    <div class="login-container">
        <div class="logo-container">
    """, unsafe_allow_html=True)
    
    # Učitaj glavni logo (400px) - OVO JE JEDINSTVENI PRIKAZ
    logo = load_image_from_url("https://i.postimg.cc/PfKTSZBT/Phantasmed-logo.png", 400)
    if logo:
        st.image(logo, use_column_width=False, output_format="PNG")
    else:
        # Fallback ako logo ne može učitati
        st.markdown("""
        <div style='color: #1a237e; font-size: 2.5rem; margin-bottom: 1rem; font-weight: bold;'>PHANTASMA</div>
        """, unsafe_allow_html=True)
    
    # Zatvori logo container i dodaj tagline
    st.markdown("""
        </div>
    ...
    # Footer i zatvori login container
    st.markdown("""
        <div class="footer">
