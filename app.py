...
def login_screen():
    ...
    <div class="login-container">
        ...
        <form>
            <div style="margin-bottom: 1rem;">
                <input type="text" placeholder="Unesite svoj username" style="width: 100%; padding: 0.75rem; border: 1px solid #ccc; font-size: 1rem; margin-bottom: 1rem;" id="username">
            </div>
            <div style="margin-bottom: 1rem;">
                <input type="password" placeholder="Unesite svoj password" style="width: 100%; padding: 0.75rem; border: 1px solid #ccc; font-size: 1rem;" id="password">
            </div>
            <button type="submit" style="width: 100%; background: #1a237e; color: white; border: none; padding: 0.85rem; font-size: 1rem; font-weight: 600; margin-top: 1rem; border: 1px solid #1a237e; cursor: pointer;">
                PRIJAVA U PORTAL
            </button>
        </form>
    ...
    # Koristimo Streamlit formu za funkcionalnost, ali je sakrijemo
